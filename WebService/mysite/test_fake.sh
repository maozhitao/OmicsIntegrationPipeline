...
expect ":"
send "./take_webservice_input_test.sh '$studies' '$species' $input_corr $knowledge_sample $knowledge_gene $additional_filter $email $tag >${timestamp}_${tag}.log 2>${timestamp}_${tag}.error & \r\r"
expect ":"
send "logout\r"
interact
exit
