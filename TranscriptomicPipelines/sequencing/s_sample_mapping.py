...
class SequencingSampleMappingParallelParameters(object):
...
class SequencingSampleMappingParameters(object):
    def __init__(   self,
...
class SequencingSampleMappingResults(object):
    def __init__(self):
...
class SequencingSampleMappingWorker:
    def __init__(self, exp, parameters, mapping_experiment_runs, count_reads_result):
        self.exp = exp
