...
class SequencingExtractionParallelParameters(object):
...
class SequencingExtractionParameters(object):
...
class SequencingExtractionResults(object):
    def __init__(self):
        self.paired_info = {}
        self.alignment_rate = {}
...
class InferExperimentResults(object):
...
class SequencingExtractionWorker(object):
