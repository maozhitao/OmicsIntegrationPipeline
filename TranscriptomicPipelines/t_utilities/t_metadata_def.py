...
class SampleID: # CR: (object)
    ...
    def create_id(self):
        if self.source_type == SourceType.GEO.value:
            ...
            if not series_id:
                raise t_metadata_exceptions.FailedToCreateID("Series id should be provided to create id for a ArrayExpress entry") # CR: long line
